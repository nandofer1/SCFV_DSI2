<?php $this->set('title_for_layout', 'Editar vehiculo'); ?>
<div class="users form">
    <fieldset>
    <legend><?php echo __('Editar Vehiculo'); ?></legend>
    <?php
    ...
    <div class="input select">
      <label>Modelo: </label>
      <select name="data[Vehicle][modell_id]" id="VehiculoModellid">
        <option value="">Seleccione una opcion</option>
        <?php foreach ($Modelos as $Modelo):?>
        <option value="<?php echo $Modelo['Modell']['id']; ?>" <?php echo $Modelo['Modell']['id']==$Modelo_id['Vehicle']['modell_id']?'selected="selected"':''  ?>>
    ...
    <div class="input select" id="VehicleAnio">
      ...
      <select name="data[Vehicle][anio]" >
        ...
        <option value="<?php echo $i?>" <?php echo $i==$Modelo_id['Vehicle']['anio']?'selected="selected"':''  ?>> <?php echo $i ?> </option>
        <?php endfor;?>
      </select>
    </div>
    <?php
