...
'<table cellspacing="0" cellpadding="1" cellspacing="1" border="0.5">
 ...
 foreach($Vehiculos as $ks => $Vehiculo):
	...
	$tbl.='<td width="40px">'.$Vehiculo['Devehicle']['id'].'</td>';
        
       // $tbl.='<td>'.$Vehiculo['Modell']['modelo'].'</td>';
         
       $tbl.='<td>'.$Vehiculo['Type']['tipo'].'</td>';
        
        $tbl.='<td>'.$Vehiculo['Devehicle']['tarjeta_circulacion'].'</td>';
        
        $tbl.='<td width="60px">'.$Vehiculo['Devehicle']['fecha_tarjeta'].'</td>';
        
        $tbl.='<td width="30px">'.$Vehiculo['Devehicle']['anio'].'</td>';
        
        $tbl.='<td>'.$Vehiculo['Devehicle']['color'].'</td>';
        
        $tbl.='<td>'.$Vehiculo['Devehicle']['motor'].'</td>';
        
        $tbl.='<td>'.$Vehiculo['Devehicle']['tipo_gasolina'].'</td>';
       $tbl.='<td>$'.$Vehiculo['Devehicle']['costo'].'</td></tr>';
